...
class ServicesRepoImpl implements ServicesRepo {
  ...
  ServicesRepoImpl(this.servicesService);


  @override
  Future<Either<Failure, List<ServicesEntity>>> getAllProducts( int? nextPage) async {
    final result = await Connectivity().checkConnectivity();
    if (result == ConnectivityResult.mobile ||
        result == ConnectivityResult.wifi) {
      try {
        final getContracts = await servicesService.getAllServices( nextPage);
