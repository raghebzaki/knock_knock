...
class TrackServicesOrderView extends StatefulWidget {
  final ServicesOrderEntity orderDetails;

  const TrackServicesOrderView({
    super.key,
    required this.orderDetails,
  });

  @override
  State<TrackServicesOrderView> createState() => _TrackServicesOrderViewState();
}

class _TrackServicesOrderViewState extends State<TrackServicesOrderView> {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (context) => di.di<TrackServicesOrderCubit>(),
        ),
      ],
      child: BlocConsumer<TrackServicesOrderCubit, TrackServicesOrderStates>(
        ...
        builder: (context, state) {
          TrackServicesOrderCubit trackOrderCubit = TrackServicesOrderCubit.get(context);
          return Scaffold(
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  Text(
                                    "${int.parse(widget.orderDetails.totalPrice!)+AppConstants.deliveryFee}",
                                    style:
                                        CustomTextStyle.kTextStyleF12.copyWith(
