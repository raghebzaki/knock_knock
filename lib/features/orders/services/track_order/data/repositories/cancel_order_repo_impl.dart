...
class CancelServicesOrderRepoImpl implements CancelServicesOrderRepo {
  final CancelServicesOrderService cancelOrderService;

  CancelServicesOrderRepoImpl({required this.cancelOrderService});

  @override
  Future<Either<Failure, CancelServicesOrderEntity>> cancelOrder(
