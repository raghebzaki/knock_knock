...
class CancelServiceOrderRepoImpl implements CancelServiceOrderRepo {
  final CancelServiceOrderService cancelOrderService;

  CancelServiceOrderRepoImpl({required this.cancelOrderService});

  @override
  Future<Either<Failure, CancelServiceOrderEntity>> cancelOrder(
