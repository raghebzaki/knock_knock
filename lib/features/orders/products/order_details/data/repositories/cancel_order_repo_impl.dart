...
class CancelProductOrderRepoImpl implements CancelProductOrderRepo {
  final CancelProductOrderService cancelOrderService;

  CancelProductOrderRepoImpl({required this.cancelOrderService});

  @override
  Future<Either<Failure, CancelProductOrderEntity>> cancelOrder(
